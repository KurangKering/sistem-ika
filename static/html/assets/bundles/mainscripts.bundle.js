...
$.AdminSwift = {}, $.AdminSwift.options = {
    ...
    setMenuHeight: function() {
        if (void 0 !== $.fn.slimScroll) {
            var a = $.AdminSwift.options.leftSideBar,
...
$.AdminSwift.browser = {
    ...
    $.AdminSwift.browser.activate(), $.AdminSwift.leftSideBar.activate(), $.AdminSwift.rightSideBar.activate(), $.AdminSwift.navbar.activate(), $.AdminSwift.input.activate(), $.AdminSwift.select.activate(), $.AdminSwift.search.activate(), setTimeout(function() {
